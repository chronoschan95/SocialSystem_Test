...
const TimeDisplay = ({ isDarkMode }) => {
  ...
  return (
    <div className={`w-full mx-auto mt-16 ${isDarkMode ? 'text-gray-300' : 'text-gray-800'}`}>
      {/* Digital Clock */}
      <div className="text-center mb-8">
        <div className={`text-4xl font-bold mb-2 pt-4 ${isDarkMode ? 'text-pink-400' : 'text-pink-600'}`}>
